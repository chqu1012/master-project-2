...
import de.dc.hska.gef.uml.editor.command.CreateEditorGuideCommand;
import de.dc.hska.gef.uml.editor.command.DeleteEditorGuideCommand;
import de.dc.hska.gef.uml.editor.command.MoveEditorGuideCommand;
...
public class EditorRulerProvider extends RulerProvider {  
    ...
    public Command getCreateGuideCommand(int position) {  
        ...
        return new CreateEditorGuideCommand(ruler, position);  
  
    }  
  
    public Command getDeleteGuideCommand(Object guide) {  
  
        return new DeleteEditorGuideCommand((Guide) guide, ruler);  
  
    }  
  
    public Command getMoveGuideCommand(Object guide, int pDelta) {  
  
        return new MoveEditorGuideCommand((Guide) guide, pDelta);  
    }  
